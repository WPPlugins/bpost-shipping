...
class WC_BPost_Shipping_Meta_Handler {
	 ...
	 */
	public function set_delivery_point( $delivery_point ) {
		$this->set_meta( self::KEY_DELIVERY_POINT, $delivery_point );
	}
	...
	/**
	 * @param string $delivery_date format 'Y-m-d'
	 */
	public function set_delivery_date( $delivery_date ) {
		$this->set_meta( self::KEY_DELIVERY_DATE, $delivery_date );
	}
	...
	public function set_order_reference( $order_reference ) {
		$this->set_meta( self::KEY_ORDER_REFERENCE, $order_reference );
	}
	...
	/**
	 * @param string|int $phone_number type is depending how you consider phone number. String is better idea to avoid issue with the zero at the begin of a number
	 */
	public function set_phone( $phone_number ) {
		$this->set_meta( self::KEY_PHONE_NUMBER, $phone_number );
	}
	...
	public function set_email( $email ) {
		$this->set_meta( self::KEY_EMAIL, $email );
	}
	...
	public function set_delivery_point_id( $delivery_point_id ) {
		$this->set_meta( 'delivery_method_point_id', $delivery_point_id );
	}
	...
	public function get_delivery_point_id_value() {
		return $this->get_value( 'delivery_method_point_id' );
	}
}
